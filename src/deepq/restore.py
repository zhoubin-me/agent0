...
if __name__ == '__main__':
    ...
    analysis = tune.run(
        ...
        restore='/home/bzhou/ray_results/atari_deepq15/Trainer_0_game=BeamRider_2020-08-18_18-07-26cg6rw7wa/checkpoint_22300/checkpoint',
        config=dict(
            # game=tune.grid_search(['Pong', 'Asterix', 'Qbert', 'SpaceInvaders']),
